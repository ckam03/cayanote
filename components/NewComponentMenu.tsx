...
const NewComponentMenu = () => {
  ...
  return (
    <div className="w-6 h-6 mt-14 ml-4 shadow-md text-gray-800 font-Roboto z-50">
      <Menu>
        <Menu.Button>
        ...
        >
          <Menu.Items as="div" className="w-60 shadow-lg rounded-lg bg-white dark:bg-gray-600">
            <h1 className="text-center font-Roboto font-semibold text-lg py-2 dark:text-gray-200">Components</h1>
            <Menu.Item>
              {({ active }) => (
                <button
                  id="Todo"
            ...
            <Menu.Item>
              {({ active }) => (
                <li
                  ...
                  className={`${
                    active ? "bg-blue-500 text-white" : " text-black"
                  } flex items-center py-2 px-3 cursor-pointer rounded-lg dark:text-gray-300`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6 mr-3"
